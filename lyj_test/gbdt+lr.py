...
def gbdt_lr_train(libsvmFileName):
    ...
    print('X_test.toarray',X_test.toarray())
    ...
    print('predict_proba',gbdt.predict_proba(X_test.toarray()),'shape',gbdt.predict_proba(X_test.toarray()).shape)
    ...
    print('apply',gbdt.apply(X_train)[:,:,0])
...
if __name__ == '__main__':
    gbdt_lr_train('../data/agaricus.txt.train')
